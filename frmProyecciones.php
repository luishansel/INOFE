...
<?php }
	else
	{
		...
		$PermisoUsuario = fxPermisoUsuario("repProyecciones", $mbAgregar, $mbModificar, $mbBorrar, $mbAnular);
		...
		<?php }
			...
			<div class = "row">
				<div class="col-xs-12 col-md-11">
					<div class="degradado"><strong>Proyecciones</strong></div>
				</div>
			</div>			
            <div class="row">
            	<div class="col-xs-12 col-xs-offset-none col-md-12 col-md-offset-2">
                    <form name="frmProyecciones" action="repProyecciones.php" target="_blank" method="post" onsubmit="return verificarFormulario()">
...
<script type='text/javascript'>
	function verificarFormulario()
	{
		...
		if (document.getElementById('dtpFechaIni').value < fechaSQL)
		{
			$.messager.alert('INOFE','La Fecha Inicial debe ser mayor o igual que Hoy.','warning');
			return false;
		}
