...
<?php }
	else
	{
		...
		$PermisoUsuario = fxPermisoUsuario("repMatGeneral", $mbAgregar, $mbModificar, $mbBorrar, $mbAnular);
		...
		<?php }
			...
			<div class = "row">
				<div class="col-xs-12 col-md-11">
					<div class="degradado"><strong>Matrícula general</strong></div>
				</div>
			</div>

            <div class="row">
            	<div class="col-xs-12 col-xs-offset-none col-md-12 col-md-offset-2">
                    <form name="repMatGeneral" action="repMatriculaGeneral.php" target="_blank" method="post" onsubmit="return verificarFormulario()">
						<div class = "form-group row">
                        	<label class="col-sm-2 col-md-4 col-form-label">Cursos que iniciaron en el período</label>
                        </div>
