...
<?php }
	else
	{
		...
		$PermisoUsuario = fxPermisoUsuario("catDocentes", $mbAgregar, $mbModificar, $mbBorrar, $mbAnular);
        ...
        $(function() {
            ...
            $("#edit").on("click", function() {
                if ($.trim($("#grid").bootgrid("getSelectedRows")) != "")
                {
                    ...
                    $.redirect("catDocentes.php", {KDSA: codDocente}, "POST");
                }
		    });
			...
			$("#remove").on("click", function() {
                ...
                {
                    var codDocente = $.trim($("#grid").bootgrid("getSelectedRows"));
                    $.redirect("gridDocentes.php", {KDSA: codDocente}, "POST");
                }
			});
        });
    </script>
