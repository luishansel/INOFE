...
else
{
	...
	$msCodCurso = $_POST["codCurso"];
	$msNomCurso = $_POST["nomCurso"];

	$pdf = new PDF('P', PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
	$pdf->msNombre=$msNomCurso;
	...
	$msHTML .= '<th style="text-align: center;background-color:rgb(0,0,255);color: white; width: 10%">Monto</th>';
	...
	$msConsulta = "select COBRO_REL, FECHAPREVISTA_050, CONCEPTO_050, MONTO_050, ACTIVO_050, ANULADO_050, ";
	...
	$msConsulta .= "from KDSA050A where CURSO_REL = ?";
